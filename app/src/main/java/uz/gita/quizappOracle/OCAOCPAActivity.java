...
public class OCAOCPAActivity extends AppCompatActivity{
    ...
    private int questionsAmount = 20;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetListOfQuestion3 getListOfQuestion3 = GetListOfQuestion3.getInstance(getResources());
        getQuestionsAndKeysAndAnswers = getListOfQuestion3.getQuestions(getSelectedTopicName);
//        questionsAmount = getQuestionsAndKeysAndAnswers.size();
    ...
    private void finishTest(){
        Intent intent = new Intent(OCAOCPAActivity.this, WinActivity.class);
