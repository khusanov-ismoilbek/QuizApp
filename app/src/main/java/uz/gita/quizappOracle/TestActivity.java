...
import uz.gita.quizappOracle.controller.GetListOfQuestion1;
...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetListOfQuestion1 getListOfQuestion1 = GetListOfQuestion1.getInstance(getResources());
        getQuestionsAndKeysAndAnswers = getListOfQuestion1.getQuestions(getSelectedTopicName);
    ...
    private void finishTest(){
        Intent intent = new Intent(TestActivity.this, WinActivity.class);
...
//        Toast.makeText(this, radioButtons.get(selectRadioPosition).getText().equals(getQuestionsAndKeysAndAnswers.get(position - 1).getCorrectAnswer()) + "", Toast.LENGTH_SHORT).show();
    ...
    View v = LayoutInflater.from(this).inflate(R.layout.activity_dialog_answer, null);
        ...
        if (check()){
            ...
            correctWrong.setTextColor(Color.parseColor("#00C385"));
