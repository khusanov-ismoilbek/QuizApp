...
public class GetListOfQuestion2 {
    ...
    private List<ModelApp> advancedClassDesign = new ArrayList<>();
    ...
    private List<ModelApp> designPatternAndPrinciples = new ArrayList<>();
    ...
    private List<ModelApp> genericsAndCollections = new ArrayList<>();
    ...
    private List<ModelApp> functionalProgramming = new ArrayList<>();
    ...
    private List<ModelApp> datesStringsAndLocalization = new ArrayList<>();
    ...
    private List<ModelApp> assessmentTestOSP = new ArrayList<>();
