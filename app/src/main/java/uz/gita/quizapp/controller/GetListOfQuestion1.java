...
public class GetListOfQuestion1 {
    ...
    private List<ModelApp> assessmentTest = new ArrayList<>();
    ...
    private List<ModelApp> operatorsAndStatements = new ArrayList<>();
    ...
    private List<ModelApp> coreJavaAPIs = new ArrayList<>();
    ...
    private List<ModelApp> methodsAndEncapsulation = new ArrayList<>();
    ...
    private List<ModelApp> classDesign = new ArrayList<>();
    ...
    private List<ModelApp> exceptions = new ArrayList<>();
